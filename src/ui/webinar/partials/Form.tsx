        ...
        <Grid columns={12} gutter={32}>
              ...
              <Grid columns={12}>
                ...
                <Grid.Col span={12}>
                  <TextInput
                    ...
                    radius="md"
                    leftSection={<IconBrandZoom size={18} stroke={1.5} />}
                    {...form.getInputProps('webinar_url')}
                  />
                </Grid.Col>
                ...
                <Grid.Col span={12}>
                  <TextInput
                    ...
                    radius="md"
                    leftSection={<IconBrandYoutube size={18} stroke={1.5} />}
                    {...form.getInputProps('recording_url')}
                  />
                </Grid.Col>
          ...
          <Grid.Col span="auto">
            <Stack gap={10}>
              ...
              <Checkbox
                checked={form.values.is_premium}
  ...
  return (
    <AbstractForm
      initialValues={{
        ...
        is_premium: validate.boolean(query?.data?.is_premium),
      }}
      isEdit
